...
from .DeviceInterfaces.ITelescopeV4 import ITelescopeV4
from .MyDeviceDriver import MyDeviceDriver


class MyTelescopeDriverV4(MyDeviceDriver, ITelescopeV4):

    def __init__(self):
        super().__init__("MyASCOMTelescopeDriverV4", "My Telescope Driver V4")
        self.__connecting = False
        self.__device_state = []  # same placeholder as V3
        self.__ra = 0.0
        self.__dec = 0.0
    ...
    def Disconnect(self):
        self.__connecting = True
        self.logger.info("Starting Telescope V4 disconnection workflow")
